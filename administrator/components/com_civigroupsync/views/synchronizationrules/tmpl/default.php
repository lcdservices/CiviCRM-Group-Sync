...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_civigroupsync&task=synchronizationrules.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'synchronizationruleList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="synchronizationruleList">
		<thead>
			<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CIVIGROUPSYNC_SYNCHRONIZATIONRULES_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
          <?php $jGroupName = CiviGroupSyncBackendHelper::getJGroupName($item->jgroup_id); ?>
          ...
          <?php endif; ?>
				...
				<td>
          <?php $cGroupName = CiviGroupSyncBackendHelper::getCGroupName($item->cgroup_id); ?>
          <?php if ($canEdit || $canEditOwn) : ?>
            <a href="<?php echo JRoute::_('index.php?option=com_civigroupsync&task=synchronizationrule.edit&id='.$item->id);?>">
